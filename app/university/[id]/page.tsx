    ...
    <>
      <div className="lg:container px-4 w-full lg:grid lg:grid-cols-12">
        <div className="University_Data lg:col-span-9  mt-12 flex flex-col gap-8 mb-12">
          <h1 className="max-sm:text-base sm:text-2xl md:text-3xl lg:text-4xl text-center font-bold text-primary">
            {university.name} Admissions Open
          </h1>
            ...
            <table className="min-w-full border-collapse border border-primary text-primary font-semibold">
              <tbody>
                <tr>
                  ...
                  <td className="px-4 max-sm:py-2 md:py-3 xl:py-4 border border-primary text-center max-sm:text-xs md:text-base lg:text-lg">
                    {university.location.city}, {university.location.province}
                  </td>
                </tr>
                <tr>
                  <td className="px-4 max-sm:py-2 md:py-3 xl:py-4 border border-primary text-center max-sm:text-xs md:text-base lg:text-lg">
                ...
                <tr>
                  ...
                  <td className="px-4 max-sm:py-2 md:py-3 xl:py-4 border border-primary text-center max-sm:text-xs md:text-base lg:text-lg text-red-600 font-semibold">
                    {new Date(
                      university.admissionDates.deadlineDate
          ...
          <div className="University_Description text-center w-[95%]">
            <h1 className="max-lg:text-xs leading-relaxed text-purple-800 dark:text-purple-500 font-bold  lg:text-lg ">
              {university.universityDescription}
            </h1>
          </div>

          <div className="University_Programs">
            <h1 className="text-center  max-sm:text-3xl md:text-4xl 2xl:text-5xl text-orange-400 font-semibold">
              Offered Programs
            </h1>
            ...
            <Programinfo university={university} program={"fcpsmcpsPrograms"} />
          ...
          <div className="Advertisement_Picture flex flex-col gap-8 justify-center items-center">
            ...
            <div>
              <a href={university.hrAdmissionNotice} target="_blank">
                <button className="px-10 py-3 bg-primary font-bold text-lg rounded-full text-secondary">
                  Large Size View
                </button>
              </a>
            </div>
          ...
          <div className="HOW_TO_APPLY? text-center flex flex-col gap-8">
            <h1 className="text-lg md:text-xl text-primary font-semibold w-[80%] mx-auto">
              Click the below link to Apply for Admission in {university.name}
            </h1>
