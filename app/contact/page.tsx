      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <h2 className="text-white text-2xl font-bold mb-8">Send Us Your Message</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <input
                ...
                required
                className="w-full bg-slate-800/50 border border-slate-700 rounded-lg p-4 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-yellow-500"
              />
          ...
          <div className="text-white pt-14">
                              ...
                              <div className="space-y-6 mb-12">
                                ...
                                <div className="flex items-start gap-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-slate-300">Ali Town, Faisalabad, Pakistan
                                    </p>
                                  </div>
                                </div>
                              </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a 
                      ...
                      className="bg-slate-800 p-3 rounded-lg hover:bg-slate-700 transition-colors duration-200 group"
                      aria-label="WhatsApp"
                    >
                      <svg 
                        viewBox="0 0 24 24" 
                        className="w-6 h-6 text-slate-400 group-hover:text-yellow-500 transition-colors duration-200"
                        fill="currentColor"
                      >
                    ...
                    <a 
                      ...
                      className="bg-slate-800 p-3 rounded-lg hover:bg-slate-700 transition-colors duration-200 group"
                    >
                      <Instagram className="w-6 h-6 text-slate-400 group-hover:text-yellow-500 transition-colors duration-200" />
                    </a>
                    ...
                    <a 
                      ...
                      className="bg-slate-800 p-3 rounded-lg hover:bg-slate-700 transition-colors duration-200 group"
                    >
                      <Youtube className="w-6 h-6 text-slate-400 group-hover:text-yellow-500 transition-colors duration-200" />
                    </a>
                    ...
                    <a 
                      ...
                      className="bg-slate-800 p-3 rounded-lg hover:bg-slate-700 transition-colors duration-200 group"
                    >
                      <Facebook className="w-6 h-6 text-slate-400 group-hover:text-yellow-500 transition-colors duration-200" />
                    </a>
                  </div>
                  </div>
          </div>
