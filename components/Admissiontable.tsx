  ...
  return (
    <div>
      <div className="HIDE FILTER BOX OR NOT mb-11">
          <h1 className="border-b border-primary cursor-pointer inline-block select-none text-base lg:text-xl xl:text-2xl text-primary font-bold" onClick={() => sethide(!hide)}>  Filter University Admissions <span className="inline-block text-center"><Filter size={`20px`}/></span> </h1>
      </div>
      {!hide && (
        <Sortingtable
