  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-black dark:bg-neutral-100">
      ...
      >
        {/* Outer rotating ring */}
        <motion.div
          className="w-24 h-24 rounded-full border-t-4 border-r-4 border-yellow-500/50"
          animate={{ rotate: 360 }}
        ...
        {/* Center dot */}
        <motion.div
          className="absolute top-1/2 left-1/2 w-4 h-4 -mt-2 -ml-2 bg-yellow-500 rounded-full"
